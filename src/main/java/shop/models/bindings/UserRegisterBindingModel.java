...
public class UserRegisterBindingModel {
    ...
    @Length(min = 5, max = 35, message = EMAIL_MIN_MAX_ERROR_MSG)
    ...
    @Length(min = 2, max = 35, message = FIRST_NAME_MIN_MAX_ERROR_MSG)
    ...
    @Length(min = 2, max = 35, message = LAST_NAME_MIN_MAX_ERROR_MSG)
    ...
    @Length(min = 1, max = 10, message = POST_CODE_MIN_MAX_ERROR_MSG)
